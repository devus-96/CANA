...
{
    public function __invoke (Request $request, EventInstance $event)
    {
        try {
            ...
            if ($request->quantity > $event->available_spots) {
            ...
            // Si l'événement est gratuit, créer directement la réservation
                ...
                $generator = new ReceiptGenerator($reservation, $event,  $userData);
